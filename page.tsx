...
export default function EsthelaPlatform() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-white font-sans selection:bg-[#621132] selection:text-[#B38E5D]">
      <Head>
        <title>Esthela Damián: El Proyecto Federal en Guerrero</title>
        <meta name="description" content="La mujer de confianza en el proyecto de Nación para construir el Segundo Piso de la Transformación en Guerrero." />
        <meta property="og:title" content="Esthela Damián: El Proyecto Federal en Guerrero" />
        <meta property="og:description" content="La defensora del proyecto federal que conecta a Guerrero con el Bienestar Nacional. Súmate." />
        {/* Asegurar que la imagen proyecte poder, junto a la Federación si es posible */}
        <meta property="og:image" content="https://guerreroescone.vercel.app/assets/img/og-esthela-poder.jpg" />
        <meta property="og:url" content="https://guerreroescone.vercel.app/" />
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center pt-20">
          ...
          >
            <div className="relative w-full aspect-[4/5] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              ...
              {/* Sugerencia: Imagen de Esthela en posición de poder o junto a figura federal */}
              <img 
